        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl text-white">
            ...
            <p className="text-xl leading-relaxed">
              Мы создаем уникальные авторские украшения, которые рассказывают истории и дарят эмоции. 
              Каждое изделие — это частичка души мастера, воплощенная в драгоценных камнях и металлах.
            </p>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <section className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#6b4e3d] mb-6">
                Наша история
              </h2>
              <div className="space-y-4 text-[#8b7355] leading-relaxed">
                <p>
                  <strong className="text-[#6b4e3d]">Masterskaya Mama</strong> — это семейная мастерская, 
                  которая появилась из любви к прекрасному и желания создавать что-то особенное своими руками.
                </p>
                <p>
                  Все началось с маленького хобби — создания украшений для близких. Постепенно это увлечение 
                  переросло в настоящее дело, которому мы посвящаем всю свою душу.
                </p>
                <p>
                  Сегодня мы создаем авторские украшения из натуральных камней, драгоценных металлов и 
                  качественных материалов, каждое изделие проходит через наши руки с особой заботой и вниманием.
                </p>
              </div>
            </div>
